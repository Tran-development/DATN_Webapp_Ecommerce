...
const Faq = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-gradient-to-b from-white to-green-100 pt-16 pb-28">
        <img className="absolute bottom-0 left-1/2 transform -translate-x-1/2" src="images/banner-faq.png" />
        <div className="text-center text-[#136] text-3xl leading-12 font-medium">How can we help you?</div>
          <p className="absolute top-20 text-center inset-12 sm:inset-0 flex items-center justify-center sm:text-sm text-[12px] sm:top-8 italic font-semibold">If your issue is not listed below, please click to access assistance from our virtual assistant. Thank you!</p>
      </div>
