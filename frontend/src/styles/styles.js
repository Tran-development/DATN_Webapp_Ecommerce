const styles = {
    ...
    shop_name:"pt-5 text-[15px] text-organic-600 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
    button: 'group overflow-hidden px-5 py-2.5 flex justify-center rounded-md items-center relative bg-[#ff7800] cursor-pointer',
    ...
    lineMenu: "cursor-pointer py-1 hover:text-gray-800 relative after:lg:absolute after:lg:bottom-0 after:lg:left-0 after:lg:h-0.5 after:lg:w-0 hover:after:lg:w-full after:lg:transition-all after:lg:ease-in-out after:lg:duration-300"
  };
