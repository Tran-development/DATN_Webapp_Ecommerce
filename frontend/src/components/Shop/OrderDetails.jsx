    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      <div className="w-full flex items-center justify-between">
        ...
        <Link to="/dashboard-orders">
          <div
            className={`${styles.button} !rounded-[4px] text-white font-[600] !h-[45px] text-[18px]`}
          >
            Order List
          </div>
        </Link>
      ...
      <div
        className={`${styles.button} w-[200px] mt-5 !rounded-[4px] text-white font-[600] !h-[45px] text-[18px]`}
